<div id="main_columns">
	<div id="pb-left-column">
		<div id="image-block"> 
			<span id="view_full_size">
				<img height="300" width="300" id="bigpic" alt="{$entity->name}" title="{$entity->name}" src="{$link->getImageLink($entity->id_image_default,'large')}" style="display: inline;">
			</span>
		</div>
		{if $images}
	...
	<div id="pb-right-column" class="pt-standard" itemtype="http://schema.org/Product" itemscope="">
		<div class="inner-aside-product">
			<form action="{$root_dir}cart.html" method="post" class="add_to_cart_form">
			...
			{if $entity->orders>0}
				...
				{/if}
				{if $entity->special_price>0}
				<div class="row-panel">
					<h3 class="title-panel">Retail Price:</h3>
					<div class="panel">
						<del class="original-price notranslate">
							US <span id="sku-price">{displayPrice price=$entity->special_price}</span>
							/  Pair </del>
