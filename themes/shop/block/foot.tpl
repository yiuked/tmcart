<div class="pt-standard footer-center">
  <div class="inner">
	<div role="navigation" class="nav secondary">
	  <div class="col">
		<h3>Your questions</h3>
		<ul>
		  <li> <a href="{$link->getPage('ContactView')}">Contact customer service</a> </li>
		  <li> <a href="{$link->getPage('MyordersView')}">Track your order</a> </li>
		  <li> <a href="{$link->getPage('CMSView',145)}">FAQ</a> </li>
		</ul>
		<h3 class="skip-default">Our guides</h3>
		<ul class="skip-default">
		  <li> <a href="{$link->getPage('CMSView',144)}">Shoes Size guide</a> </li>
		  <li> <a href="{$link->getPage('CMSView',148)}">Clothing Size guide</a> </li>
		</ul>
	  </div>
	  <div class="col skip-default">
		<h3>What's {$shop_name} all about?</h3>
		<ul>
	  ...
	  <div class="col skip-default">
		<h3>The {$shop_name} world</h3>
		<ul>
		  <li> <a href="{$link->getPage('CMSView',142)}">Who are we?</a> </li>
		  <li> <a href="/">Our awards</a> </li>
		  <li> <a href="{$link->getPage('LoginView')}">Join us</a> </li>
		  <li> <a href="/">Affiliate programme</a> </li>
		  <li> <a href="{$link->getPage('CMSView',149)}">Promo code</a> </li>
		</ul>
	  </div>
	</div>
	<div class="customer-service">
	  ...
	  <div class="col">
		<h4>By e-mail</h4>
		<a href="mailto:smilecustomerservices@hotmail.com" class="all txt-14"><img src="{$img_dir}email.png" style="vertical-align: text-bottom;"></a> </div>
	</div>
	 <div class="clear"></div>
  </div>
</div>
...
<div class="copyrignt">
  <span>&copy; 2015 {$shop_name}, Inc. All Rights Reserved</span>
  <ul class="floatr">
	<li><a href="{$root_dir}">*Current offer conditions</a></li>
	<li><a href="{$root_dir}">Terms and conditions</a></li>
	<li><a href="{$root_dir}">Privacy information</a></li>
  </ul>
</div>
