...
<div class="mianForm">
	<form enctype="multipart/form-data" method="post" action="index.php?rule=cmscategory_edit<?php echo isset($id)?'&id='.$id:''?>" class="defaultForm admincmscontent" id="cms_category_form" name="example">
		  <fieldset>
		...
		<script type="text/javascript">
			...
			<input type="hidden" value="<?php echo isset($id)?'edit':'add'?>"  name="sveCMSCategory">
		  </fieldset>
	</form>
</div>
