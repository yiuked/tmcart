...
$btn_group = array(
	array('type' => 'a', 'title' => '分类Metat管理', 'href' => 'index.php?rule=seo_meta', 'class' => 'btn-primary', 'icon' => 'share') ,
...
$form->items = array(
	'title' => array(
		...
		'type' => 'text',
		'value' => Tools::Q('title'),
		'info' => '可用参数:P_ID,P_NAME,P_PRICE,P_OLD_PRICE,P_SKU,P_CATEGORY,P_COLOR,{关键词1|关键词2|关键词3}'
	),
	'keywords' => array(
		'title' => 'Keywords规则',
		'type' => 'text',
	...
	'id_brands' => array(
		'title' => '应用到品牌',
		'type' => 'select',
		'value' =>Tools::Q('id_brands'),
		'option' => $brandKeyVal,
		'info' => '不选则应用到所有品牌'
	),
	'SEOProductMetaUpdate' => array(
		'type' => 'submit',
		'class' => 'btn-success',
		'icon' => 'save',
		'title' => '生成'
