    ...
    <div class="col-md-12">
        <nav class="navbar navbar-custom">
            <ul class="nav navbar-nav">
                <a href="#" class="navbar-brand">TMSHOP</a>
                <li class="dropdown">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="index.php?rule=cms_category" title="CMS分类">CMS分类</a></li>
                        <li><a href="index.php?rule=cms" title="内容">内容</a></li>
                        <li><a href="index.php?rule=cms_comment" title="评论">访客评论</a></li>
                        <li><a href="index.php?rule=cms_tag" title="标签">内容标签</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
