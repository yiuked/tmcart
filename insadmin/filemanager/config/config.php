...
$upload_dir = __TM_BASE_URI__.'images/cms/'; // path from base_url to base of upload folder (with start and final /)
$current_path = _TM_ROOT_DIR_.'/images/cms/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = _TM_ROOT_DIR_.'/images/tmp/cms/'; // relative path from filemanager folder to thumbs folder (with final /)
