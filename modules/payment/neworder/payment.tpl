...
<label class="tab_label" for="credit_card"><img src="{$module_dir}images/logo.png" alt="Visa Card Or Master Card Or JCB Card"></label>
<div class="tab_panel">
  <div class="tab_content">
	...
	<div class="sectioncontent">
		...
		<input type="hidden" value="{$module_dir}"  id="iconPath" />
	<fieldset>
		<table class="tableform" style="width: 49%;padding: 15px 10px;">
			<tr>
				<td style="padding: 10px;">
						<label for="cc_number">Card Number</label>
						<input  type="{$cardInputType}" name="neworder_cardNo" value="" id="neworder_cardNo"  maxlength="16"
								   onkeyup="this.value=this.value.replace(/\D/g,''); checkCardType(this,'{$module_dir}');"
								   style='background-image:url("{$module_dir}images/vmj.png");background-position:right center;background-repeat:no-repeat;
			...
			<tr>
				...
				<i class="icon-info tool"><span class="tip pos-b-l"><span><img src="{$module_dir}images/cvv_demo.gif" alt="cvv demo"></span></span></i>
			...
			<tr>
				<td colspan="2" id="currenstatus">
					<p class="loader hidden"><img src="{$module_dir}images/loader.gif"></p>
			...
			<tr>
				<td  style="padding: 10px;">
				<img src="{$module_dir}images/certservices.png" alt="CVV2/CSC"/>
				</td>
			</tr>
			</table>
	</fieldset>
...
var ajaxUrl = "{$module_dir}payment.php";
{literal}
function trim(str){
