...
{capture name=path} 
<a href="{$link->getPageLink('order', true, NULL, "step=3")|escape:'htmlall':'UTF-8'}" title="{l s='Go back to the Checkout' mod='weixinpay'}">{l s='Checkout' mod='weixinpay'}</a>
...
<div class="order-box">
  <div class="o-left">
    ...
    <p class="o-tips">{l s='Please pay in' mod='weixinpay'}<span class="font-red"> {$expire_time|escape:'htmlall':'UTF-8'} {l s='minutes' mod='weixinpay'} </span>{l s='to complete the payment, otherwise the order will be automatically canceled.' mod='weixinpay'}</p>
  </div>
  <div class="o-right">
...
<div class="image-box">
  <div class="box-left"><img class="border-grey" src="{$payimage|escape:'htmlall':'UTF-8'}" alt="{l s='WeChat Pay' mod='weixinpay'}" width="300"/>
    <div class="pw-box-ft">
